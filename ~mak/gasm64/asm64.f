...
\- SBYTE? : SBYTE? ( n -- -128<n<127)  0x80 +  0x17F U< ;
\- NOT	: NOT INVERT ;
...
: %r_x: %_l: DOES> @ %r_x REX.RBX 2*    TO REX.RBX #(( IF BREAK $8 TO REX.W 1 TO REG>8 ;
: %r_n: %_l: DOES> @ %r_x REX.RBX 2* 1+ TO REX.RBX #(( IF BREAK $8 TO REX.W 1 TO REG>8 ;
...
: (()),
 ...
 #(%r_x,%r_x) 
 IF	((OFFSET
  IF	((OFFSET SBYTE? \ ." #(%r_x,%r_x)=<" CR .S ." >" CR KEY DROP
...
: notq,		$8 TO REX.W notl,	; 
: negq,		$8 TO REX.W negl,	; 
: mulq,		$8 TO REX.W mull,	; 
: imulq,	$8 TO REX.W imull,	; 
: divq,		$8 TO REX.W divl,	; 
: idivq,	$8 TO REX.W idivl,	;  
...
: j?   OVER 1- HERE - SBYTE? IF $70 OR #lp, BREAK
		$f C,  $80 + C, 4 - HERE - L,  ;
: jo,  	$0 j? ;
: jno, 	$1 j? ;
: jb,  	$2 j? ;
