...
AHEADER 0 ,'UPPER',cfa_UPPER
 ...
 DB 08DH,06DH,010H
 DB 0BBH
 DD (cfa_UPPER+051H) and 0ffffffffh
 DB 03BH,045H,0F0H
;jne cfa_UPPER+01DH
 DB 075H,06H
 DB 048H
...
AHEADER 0 ,'TYPE_M',cfa_TYPE_M
 ...
 DB 08DH,06DH,010H
 DB 0BBH
 DD (cfa_TYPE_M+042H) and 0ffffffffh
 DB 03BH,045H,0F0H
;jne cfa_TYPE_M+01DH
 DB 075H,06H
 DB 048H
...
AHEADER 0 ,'DUMP',cfa_DUMP
 ...
 call cfa_XDO+00H
 DB 068H
 DD (cfa_DUMP+011FH) and 0ffffffffh
 DB 052H
 DB 053H
 DB 090H
 DB 090H
 ...
 call cfa_XDO+00H
 DB 068H
 DD (cfa_DUMP+0FEH) and 0ffffffffh
 DB 052H
 DB 053H
 DB 090H
 DB 090H
...
AHEADER 0 ,'SET-ORDER',cfa_SETminusORDER
 ...
 call cfa_XDO+00H
 DB 068H
 DD (cfa_SETminusORDER+0A4H) and 0ffffffffh
 DB 052H
 DB 053H
 DB 090H
 DB 090H
 ...
 call cfa_Lsave+00H
 DB 0FFH,04H,024H
;jno cfa_SETminusORDER+078H
 DB 071H,0D9H
 DB 048H
 DB 08DH,064H,024H,018H
 DB 0E9H
 DD cfa_SETminusORDER+0C2H-$-4
 call cfa_DROP+00H
 call cfa_SminusO+00H
 call cfa__CONTEXT+09H
 call cfa__CONTEXT+00H
...
AHEADER 0 ,'ORDER',cfa_ORDER
 ...
 DB 08DH,06DH,010H
 DB 0BBH
 DD (cfa_ORDER+05CH) and 0ffffffffh
 DB 03BH,045H,0F0H
;jne cfa_ORDER+037H
 DB 075H,06H
 DB 048H
...
AHEADER 0 ,'GET-ORDER',cfa_GETminusORDER
 ...
 call cfa_XDO+00H
 DB 068H
 DD (cfa_GETminusORDER+03CH) and 0ffffffffh
 DB 052H
 DB 053H
 DB 090H
 DB 090H
 ...
 call cfa_XLIT+00H
 DD 04H
 call cfa_ADD_xESP_ycomTOS+00H
;jno cfa_GETminusORDER+01DH
 DB 071H,0E6H
 DB 048H
 DB 08DH,064H,024H,018H
 call cfa__CONTEXT+00H
...
AHEADER 0 ,'SFIND',cfa_SFIND
 ...
 call cfa_XDO+00H
 DB 068H
 DD (cfa_SFIND+08CH) and 0ffffffffh
 DB 052H
 DB 053H
 DB 090H
 DB 090H
...
AHEADER 0 ,'OK1',cfa_OK1
 ...
 DB 08DH,06DH,010H
 DB 0BBH
 DD (cfa_OK1+082H) and 0ffffffffh
 DB 03BH,045H,0F0H
;jne cfa_OK1+059H
 DB 075H,06H
 DB 048H
...
AHEADER 0 ,'ERR-TYPE',cfa_ERRminusTYPE
 ...
 DB 08DH,06DH,010H
 DB 0BBH
 DD (cfa_ERRminusTYPE+0A9H) and 0ffffffffh
 DB 03BH,045H,0F0H
;jne cfa_ERRminusTYPE+058H
 DB 075H,06H
 DB 048H
 DB 08BH,045H,0F8H
 DB 0FFH,0E3H
 ...
 call cfa_QBRANCH+00H
 DW 0840FH
 DD cfa_ERRminusTYPE+09AH-$-4
 call cfa_XLIT+00H
 DD 09H
 call cfa_EMIT+00H
 DB 0E9H
 DD cfa_ERRminusTYPE+09FH-$-4
 call cfa_SPACE+00H
 DB 0FFH,04H,024H
;jno cfa_ERRminusTYPE+069H
 DB 071H,0C5H
 DB 048H
 DB 08DH,064H,024H,018H
 call cfa__SLITERALminusCODE+00H
...
AHEADER 0 ,'_ERROR_DO',cfa__ERROR_DO
 ...
 DB 08DH,06DH,010H
 DB 0BBH
 DD (cfa__ERROR_DO+0DEH) and 0ffffffffh
 DB 03BH,045H,0F0H
;jne cfa__ERROR_DO+08DH
 DB 075H,06H
 DB 048H
 DB 08BH,045H,0F8H
 DB 0FFH,0E3H
 ...
 call cfa_QBRANCH+00H
 DW 0840FH
 DD cfa__ERROR_DO+0CFH-$-4
 call cfa_XLIT+00H
 DD 09H
 call cfa_EMIT+00H
 DB 0E9H
 DD cfa__ERROR_DO+0D4H-$-4
 call cfa_SPACE+00H
 DB 0FFH,04H,024H
;jno cfa__ERROR_DO+09EH
 DB 071H,0C5H
 DB 048H
 DB 08DH,064H,024H,018H
 call cfa__SLITERALminusCODE+00H
...
AHEADER 1 ,'+LOOP',cfa_plusLOOP
 ...
 call cfa_QBRANCH+00H
 DW 0840FH
 DD cfa_plusLOOP+050H-$-4
 call cfa_XLIT+00H
 DD 071H
 call cfa_Ccom+00H
 call cfa_Ccom+00H
 DB 0E9H
 DD cfa_plusLOOP+07FH-$-4
 call cfa_XLIT+00H
 DD 04H
 call cfa_minus+00H
 call cfa_XLIT+00H
