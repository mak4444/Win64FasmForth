...
S" src/SYS/spf_SYS_const.f"          INCLUDED 
...
S" src/SYS/spf_SYS_con_io.f"         INCLUDED
S" src/spf_con_io.f"                 INCLUDED
S" src/SYS/spf_SYS_io.f"             INCLUDED
\ S" src/SYS/spf_SYS_memory.f"         INCLUDED
...
\ err S" src/SYS/spf_getxy.f"       INCLUDED
