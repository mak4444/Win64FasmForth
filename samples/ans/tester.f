...
\ ------------------------------------------------------------------------
TESTING COMPARISONS: 0= = 0< < > U< MIN MAX UMIN UMAX D<
...
{ -1 0 UMAX -> -1 }
{ -1 1 UMAX -> -1 }
{ MIN-INT 0 UMAX -> MIN-INT }
{ MIN-INT MAX-INT UMAX -> MIN-INT }
{ 0 MAX-INT UMAX -> MAX-INT }
{ 0 0 UMAX -> 0 }
{ 1 1 UMAX -> 1 }
{ 1 0 UMAX -> 1 }
{ 2 1 UMAX -> 2 }
{ 0 -1 UMAX -> -1 }
{ 1 -1 UMAX -> -1 }
{ 0 MIN-INT UMAX -> MIN-INT }
{ MAX-INT MIN-INT UMAX -> MIN-INT }
{ MAX-INT 0 UMAX -> MAX-INT }
